        ...
        <Reveal>
          <div className="contact-grid">
            <button
              ...
              onClick={() => copyText(SITE.email, "Email copied!")}
              aria-label="Copy email to clipboard"
            >
              <i className="fa-solid fa-envelope" aria-hidden="true"></i>
              <span className="contact-label">Email <span className="copy-hint">Click to copy</span></span>
              <span className="contact-value">{SITE.email}</span>
            </button>
            <button
              type="button"
              className="contact-card glass contact-card--copy"
              onClick={() => copyText(SITE.phone, "Phone number copied!")}
              aria-label="Copy phone number to clipboard"
            >
              <i className="fa-solid fa-phone" aria-hidden="true"></i>
              <span className="contact-label">Phone <span className="copy-hint">Click to copy</span></span>
              <span className="contact-value">{SITE.phone}</span>
            </button>
            <a className="contact-card glass" href={SITE.linkedin} target="_blank" rel="noopener noreferrer">
              <i className="fa-brands fa-linkedin-in" aria-hidden="true"></i>
              <span className="contact-label">LinkedIn</span>
              <span className="contact-value">{SITE.linkedinHandle}</span>
            </a>
            <a className="contact-card glass" href={SITE.github} target="_blank" rel="noopener noreferrer">
